...
public sealed partial class MediatorTypeInferenceExtensionsGenerator : IIncrementalGenerator
{
    ...
    /// </returns>
    private static MethodDeclarationSyntax CreateMethodDeclaration(string requestTypeName, string responseTypeName, bool IsStreamType)
    {
        ...
        return MethodDeclaration(ParseTypeName(returnType), Identifier(methodName))
            ...
            .WithModifiers(CreateMethodModifiers())
    ...
    /// </returns>
    /// <remarks>
    /// The generated attributes mark methods as compiler-generated, hide them from IntelliSense,
    /// and enable aggressive inlining for optimal performance.
    /// </remarks>
    ...
    /// </summary>
    /// <returns>A <see cref="SyntaxTokenList"/> containing public and static modifiers.</returns>
    private static SyntaxTokenList CreateMethodModifiers() =>
