...
public sealed partial class MediatorTypeInferenceExtensionsGenerator : IIncrementalGenerator
{
    ...
    /// <returns>
    /// A <see cref="ClassDeclarationSyntax"/> representing a public static partial class containing the specified methods.
    /// </returns>
    /// <remarks>
    /// The generated class uses the pattern <c>__{ClassName}__</c> for the class name to avoid naming conflicts.
    /// The class is marked with attributes to hide it from debugging and IntelliSense.
    /// </remarks>
    private static ClassDeclarationSyntax CreateClassDeclaration(IEnumerable<MemberDeclarationSyntax> methods) =>
    ...
    /// </returns>
    /// <remarks>
    /// The generated attributes mark the class as compiler-generated, exclude it from debugging,
    /// and hide it from IntelliSense to prevent accidental usage of the generated code.
    /// </remarks>
